...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const userPanel = (
    <div className="bg-white/10 rounded-2xl p-3 backdrop-blur-md space-y-3">
      <Link href="/profile">
        <div className="flex items-center gap-3 cursor-pointer hover:bg-white/10 rounded-xl p-1 -m-1 transition-colors">
          <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center text-white font-bold shrink-0 overflow-hidden">
